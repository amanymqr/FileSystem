        ...
        <div class="container">
            ...
            <div class="d-flex">
                ...
                <a href="{{ route('file.show') }}" class="mx-2">
                    <i style="color: #617fa9" class="bi bi-file-earmark-text"></i>
                </a>
